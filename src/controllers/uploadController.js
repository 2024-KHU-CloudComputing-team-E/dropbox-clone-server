...
const s3 = new S3Client({
  region : 'us-east-1',
  credentials : {
      accessKeyId : 'AKIA2UC3EIFM65KVHTOE',
      secretAccessKey : '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'
  }
})
    ...
    uploadFile: async (req, res) => {
      ...
      try {
        ...
        await db.collection('post').insertOne({
          filename: path.basename(req.file.originalname, path.extname(req.file.originalname)) /* + "_" + Date.now()*/ + path.extname(req.file.originalname),
          size: req.file.size,
